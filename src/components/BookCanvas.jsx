                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Dear Riddhima<span className="underline"></span>
                        </h4>
                    ...
                    <div className="userImg">
                        <img src={profileImg} alt="Recipient's Photo" />
                    </div>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, Riddhima ❤️</article>
