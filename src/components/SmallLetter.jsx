...
const SmallLetter = () => {
    ...
    <div className="small-rajib-paper-content">
        {/* Mobile Back Button for Letter */}
        <button
            className="small-letter-mobile-back"
            onClick={handleCloseLetter}
            aria-label="Close letter"
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="back-icon-small">
        ...
        <div
            className="small-rajib-paper-close desktop-close-letter"
            onClick={handleCloseLetter}
        >
            x
        </div>
        <p>Yo brocaccho,<br /><br />Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud <br /><br />Aditya</p>
    </div>
